    ...
    return (
        <div className="bg-white h-16 px-4 flex justify-between items-center border-b border-gray-200">
            <div className="relative">
                ...
                <input onChange={ (e) => { handleSearch(e) } } type="text" className="text-sm focus:outline-none active:outline-none border border-gray-300 w-[24rem] h-10 pl-11 pr-4 rounded-sm" placeholder="Search..."/>
            </div>
